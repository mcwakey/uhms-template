<template>
  <form @submit.prevent="applyFilter">
    <div class="filter-body pb-0">
      <div class="mb-3">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <a href="javascript:void(0);" class="link-primary mb-1" @click="selectedDoctor = null"
            >Reset</a
          >
        </div>
        <vue-multiselect
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <a href="javascript:void(0);" class="link-primary mb-1" @click="selectedService = null"
            >Reset</a
          >
        </div>
        <vue-multiselect
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <a href="javascript:void(0);" class="link-primary mb-1" @click="selectedStatus = null"
            >Reset</a
          >
        </div>
        <vue-multiselect
      ...
      <div class="mb-3">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <a href="javascript:void(0);" class="link-primary mb-1" @click="selectedMode = null"
            >Reset</a
          >
        </div>
        <vue-multiselect
    ...
    <div class="filter-footer d-flex align-items-center justify-content-end border-top">
      <a href="javascript:void(0);" class="btn btn-light btn-md me-2 fw-medium" @click="$emit('close')"
        >Close</a
      >
