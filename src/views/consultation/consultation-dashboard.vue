  ...
  <div class="page-wrapper">
    <div class="content pb-0">
      <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 mb-4">
        <div>
          <h4 class="fw-bold mb-0">Consultation Dashboard</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap gap-2">
          <router-link to="/appointments/new-appointment" class="btn btn-primary d-inline-flex align-items-center"><i class="ti ti-plus me-1"></i>New Consultation</router-link>
        </div>
      </div>
      <div class="row">
          ...
          <div class="position-relative border card rounded-2 shadow-sm">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-2 justify-content-between">
                <span class="avatar bg-primary rounded-circle"><i class="ti ti-stethoscope fs-24"></i></span>
                <div class="text-end">
                  <span class="badge px-2 py-1 fs-12 fw-medium d-inline-flex mb-1 bg-success">+11%</span>
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div>
                  ...
                  <h3 class="fw-bold mb-0">1,942</h3>
                </div>
                <div>
          ...
          <div class="position-relative border card rounded-2 shadow-sm">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                <div class="text-end">
                  <span class="badge px-2 py-1 fs-12 fw-medium d-inline-flex mb-1 bg-danger">-3%</span>
                  <p class="fs-13 mb-0">in last 7 Days</p>
                </div>
              </div>
              <div class="d-flex align-items-center justify-content-between">
