  ...
  <div class="page-wrapper">
    ...
    <div class="content">
      ...
      <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
        <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#add_todo"
                      ...
                      <div class="row align-items-center row-gap-3">
                        ...
                        <div class="col-lg-6 col-md-5">
                          ...
                          >
                            ...
                            <span class="badge badge-soft-secondary d-flex align-items-center me-2"
                      ...
                      <div class="row align-items-center row-gap-3">
                        ...
                        <div class="col-lg-6 col-md-5">
                          ...
                          >
                            ...
                            <span class="badge badge-soft-info d-flex align-items-center me-2"
        ...
        <div class="modal-body text-center position-relative">
          ...
          <div class="d-flex justify-content-center">
            <a
              ...
              >Cancel</a
            >
            <a href="" class="btn btn-danger position-relative z-1" data-bs-dismiss="modal"
              >Yes, Delete</a
            >
          </div>
        </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    initQuill() {
      const quill = new Quill((this.$refs as any).editorRef as Element, {
        theme: 'snow',
        modules: {
          toolbar: [
            [{ header: [1, 2, false] }],
      ...
      const quillone = new Quill((this.$refs as any).editorRefone as Element, {
        theme: 'snow',
        modules: {
          toolbar: [
            [{ header: [1, 2, false] }],
