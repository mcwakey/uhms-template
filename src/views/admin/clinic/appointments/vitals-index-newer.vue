        ...
        <div class="row">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="col-6">
                      <div class="d-flex align-items-center justify-content-between p-2 border rounded bg-light">
                        ...
                        <span :class="getServicePriorityClass()" class="badge fs-11">{{ serviceInfo.priority || 'Normal' }}</span>
                      </div>
                    </div> -->
                    </div>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap align-items-center justify-content-between gap-1">
                    ...
                    <div class="w-100">
                      <!-- <hr /> -->
                      <!-- <div class="d-flex align-items-center justify-content-between mb-1">
                        <i class="ti ti-notes text-primary fs-16"></i>
                        <span class="badge bg-soft-primary text-primary fs-11">Clinical Note</span>
                      </div> -->
                      <div>
                          ...
                          <table class="table table-hover align-middle">
                            <thead class="table-light">
                              <tr>
                                ...
                                <th></th>
                                <!-- <th>
                                <i class="ti ti-mood-sad text-danger"></i>
                                <span class="ms-1">Pain</span>
                              </th>
                              <th>
                                <i class="ti ti-eye text-primary"></i>
                                <span class="ms-1">Conscious</span>
                              </th>
                              <th>
                            ...
                            <tbody>
                              <tr
                                v-for="(vital, idx) in vitalSignsInfo &&
                                Array.isArray(vitalSignsInfo)
                                  ? vitalSignsInfo
                                  : []"
                                :key="vital.id || idx"
                                :class="{
                                  'table-danger': vital.systolic_bp > 140 || vital.temperature > 38,
                                  'table-warning': vital.systolic_bp < 90 || vital.temperature < 35,
                                  'table-success':
                                    vital.systolic_bp >= 90 &&
                                    vital.systolic_bp <= 140 &&
                              ...
                              >
                                ...
                                <td>
                                  <span
                                    :class="{
                                      'text-danger fw-bold': vital.temperature > 38,
                                      'text-warning fw-bold': vital.temperature < 35,
                                      'text-dark':
                                  ...
                                  <span
                                    :class="{
                                      ...
                                      'text-dark':
                                        vital.systolic_bp >= 90 &&
                                        vital.systolic_bp <= 140 &&
                                        vital.diastolic_bp >= 60 &&
                                        vital.diastolic_bp <= 90,
                                    }"
                                  >
                                ...
                                <td>
                                  <span
                                    :class="{
                                      'text-danger fw-bold': vital.heart_rate > 100,
                                      'text-warning fw-bold': vital.heart_rate < 60,
                                      'text-dark':
                                ...
                                <td>
                                  <span
                                    :class="{
                                      'text-danger fw-bold': vital.respiratory_rate > 20,
                                      'text-warning fw-bold': vital.respiratory_rate < 12,
                                      'text-dark':
                                        vital.respiratory_rate >= 12 &&
                                        vital.respiratory_rate <= 20,
                                    }"
                                  >
                                ...
                                <td>
                                  <span
                                    :class="{
                                      'text-danger fw-bold': vital.oxygen_saturation < 95,
                                      'text-warning fw-bold': vital.oxygen_saturation > 100,
                                      'text-dark':
                                        vital.oxygen_saturation >= 95 &&
                                        vital.oxygen_saturation <= 100,
                                    }"
                                  >
                                ...
                                <!-- <td>
                                <span :class="{
                                  'text-danger fw-bold': vital.pain_level >= 7,
                                  'text-warning fw-bold': vital.pain_level >= 4 && vital.pain_level < 7,
                                  'text-success fw-bold': vital.pain_level < 4
                                }">
                                  {{ vital.pain_level ?? '--' }}
                                </span>
                              </td> -->
                                ...
                                <!-- <td>
                                <span :class="{
                                  'text-danger fw-bold': vital.consciousness === 'Unresponsive',
                                  'text-warning fw-bold': vital.consciousness === 'Pain',
                                  'text-info fw-bold': vital.consciousness === 'Verbal',
                                  'text-success fw-bold': vital.consciousness === 'Alert'
                                }">
                                  {{ vital.consciousness ?? '--' }}
                                </span>
                              </td>
                              <td>
                                <span class="text-muted">{{ vital.notes ?? '' }}</span>
                              </td> -->
                              </tr>
                              <tr
                                v-if="
          ...
          <div class="col-xl-3 theiaStickySidebar">
            <div class="stickysidebar">
              ...
              <!-- <div class="mb-3">
                  <div v-if="triageStatus === 'Critical'" class="alert alert-danger">
                    <strong>Critical:</strong> Immediate intervention required. Notify emergency team and prepare for rapid assessment and treatment.
                  </div>
                  <div v-else-if="triageStatus === 'Urgent'" class="alert alert-warning">
                    <strong>Urgent:</strong> Needs care soon. Prioritize patient for prompt evaluation and monitor closely for deterioration.
                  </div>
                  <div v-else-if="triageStatus === 'Stable'" class="alert alert-success">
                    <strong>Stable:</strong> Routine monitoring. Continue standard care and reassess periodically.
                  </div>
                  <div v-else class="alert alert-secondary">
              ...
              <div class="card mt-3">
                ...
                <div class="card-body position-relative">
                  <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <!-- <button class="btn btn-sm btn-outline-primary" @click="loadNextPatient">
                    <i class="ti ti-arrow-right fs-12"></i> Next
                  </button>

                  <router-link
                    class="btn btn-sm btn-outline-primary"
                    :to="{ name: 'NursingPatientVitals', params: { id: nextAppointmentInfo?.id } }"
                  >
                    <i class="ti ti-arrow-right fs-12"></i> Load
                  </router-link>
                  <a
                    class="btn btn-sm btn-outline-primary"
                    :href="`/nursing/appointments/${nextAppointmentInfo?.id}/vitals`"
                  >
                    <i class="ti ti-arrow-right fs-12"></i> Load12
                </a> -->
                  </div>
                    ...
                    <div class="d-flex gap-2">
                      <router-link
                        ...
                        :to="{
                          ...
                          params: { id: nextAppointmentInfo.appointment_id },
                        }"
                      >
...
<script>
// import TodoAddModal from '@/components/modals/appointment/TodoAddModal.vue';
// import TodoViewModal from '@/components/modals/appointment/TodoViewModal.vue';
// import TodoDeleteModal from '@/components/modals/appointment/TodoDeleteModal.vue';
// import SetAppointmentModal from '@/components/modals/appointment/SetAppointmentModal.vue';
...
export default {
  ...
  data() {
    return {
      ...
      // "triageLevels": [
      // { "id": 1, "name": "Critical", "min": 7, "max": 10, "time": "Immediate", "colorClass": "bg-danger", "description": "Critical — Immediate intervention needed" },
      // { "id": 2, "name": "Urgent", "min": 4, "max": 6, "time": "Needs care soon", "colorClass": "bg-warning", "description": "Urgent — Needs care soon" },
      // { "id": 3, "name": "Stable", "min": 0, "max": 3, "time": "Routine monitoring", "colorClass": "bg-success", "description": "Stable — Routine monitoring" }
      // ],

      // triageLevels: constants.triageLevels,
      // triageLevels: require('@/constants.json').triageLevels,
  ...
  computed: {
    ...
    getLatestUpdate() {
      return (this.vitalSignsData && this.vitalSignsData.latestUpdate) || '--'
    },
  ...
  async mounted() {
    ...
    // this.appointmentNextId = Number(this.$route.params.id) + 1;

    if (this.appointmentId) {
      await this.fetchAppointmentInfo()
      await this.fetchInsuranceInfo()
      await this.fetchVitalSignsInfo()
      await this.fetchServiceInfo()
      await this.fetchNextAppointmentInfo()
    } else {
  ...
  //       // ${ Number(this.appointmentId) + 1}
  //       this.appointmentId;
  //       this.fetchAppointmentInfo();
  //       this.fetchNextAppointmentInfo();
  //       this.fetchVitalSignsInfo();
  ...
  methods: {
    async fetchAppointmentInfo() {
      try {
        ...
        this.selfUrl = this.appointmentInfo._links.self // Set selfUrl from appointment info
        this.insuranceUrl = this.appointmentInfo._links.primary_insurance // Set insuranceUrl from appointment info
        this.recordUrl = this.appointmentInfo._links.record // Set recordUrl from appointment info
        this.serviceUrl = this.appointmentInfo._links.service // Set serviceUrl from appointment info
    ...
    async fetchNextAppointmentInfo() {
      try {
        this.loading = true
        console.log(
          `Fetching next appointment info for appointment ID: ${Number(this.appointmentId) + 1}`
        )

        // if (!this.insuranceUrl) {
        //   console.warn('No insurance URL provided.');
        //   return;
        // }
    ...
    async fetchPatientInfo() {
      try {
        ...
        this.vitalsForm.height = this.patientInfo.height
        this.vitalsForm.weight = this.patientInfo.weight
    ...
    async fetchVitalSignsInfo() {
      ...
      try {
        ...
        if (!Array.isArray(this.vitalSignsInfo) || this.vitalSignsInfo.length === 0) {
        ...
        const latest = this.vitalSignsInfo[this.vitalSignsInfo.length - 1]

        console.log('Latest vital signs data:', latest)

        // this.vitalsForm.height = latest.height;
        // this.vitalsForm.weight = latest.weight;
        ...
        this.vitalSignsData = {
          ...
          notes: latest.notes ?? '',
          latestUpdate: latest.created_at ? new Date(latest.created_at).toLocaleString() : '',
        }
    ...
    async fetchServiceInfo() {
      try {
        console.log(`Fetching service info from URL: ${this.serviceUrl}`)

        const response = await axiosInstance.get(this.serviceUrl)
        this.serviceInfo = response.data

        console.log('Fetched service info:', this.serviceInfo)
      } catch (error) {
    ...
    async fetchInsuranceInfo() {
      try {
        console.log(`Fetching insurance info from URL: ${this.insuranceUrl}`)
        ...
        const response = await axiosInstance.get(this.insuranceUrl)
        this.insuranceInfo = response.data

        console.log('Fetched insurance info:', this.insuranceInfo)
      } catch (error) {
    ...
    async fetchPreviousAppointmentsInfo() {
      try {
        console.log(`Fetching previous appointments info from URL: ${this.previousAppointmentsUrl}`)

        // if (!this.previousAppointmentsUrl) {
        //   console.warn('No previous appointments URL provided.');
        //   return;
        // }

        const response = await axiosInstance.get(
          `/appointments/?patient=b9aaf067-5636-4c15-bba5-41ca1bccd32b/`
        )
        this.previousAppointmentsInfo = response.data

        console.log('Fetched previous appointments info:', this.previousAppointmentsInfo)
      } catch (error) {
        console.error('Error fetching previous appointments info:', error)
        console.error('Error details:', error.response?.data || error.message)
      }
    },
    //     console.log('Fetched insurance info:', this.insuranceInfo);
    ...
    async confirmTriage() {
      // this.updateTriageStatus();
      try {
        await axiosInstance.patch(`${this.selfUrl}`, { is_confirmed: true })
        // this.$toast?.success(`Triage confirmed: ${this.triageStatus}`);
      } catch (error) {
        // this.$toast?.error('Failed to confirm triage');
    ...
    async loadNextPatient() {
      try {
        this.loading = true
        // Fetch next appointment info and update UI
        await this.fetchNextAppointmentInfo()
        if (this.nextAppointmentInfo && this.nextAppointmentInfo.id) {
          await this.$router.replace({
            name: 'NursingPatientVitals',
            params: { id: this.nextAppointmentInfo.id },
          })
        } else {
          this.$toast?.info('No next patient in queue.')
        }
      } catch (error) {
        console.error('Error loading next patient:', error)
        this.$toast?.error('Failed to load next patient.')
      } finally {
        this.loading = false
      }
    },
