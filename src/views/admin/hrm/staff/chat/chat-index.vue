                      ...
                      <div class="chat-user-info">
                        <div class="chat-user-msg">
                          ...
                          <p class="text-success">
                            <i class="ti ti-video-plus text-success me-2"></i>Incoming Video Call
                          </p>
                        </div>
                        <div class="chat-user-time">
                          <span class="time">02:40 PM</span>
                          ...
                          <li class="emoj-action">
                            ...
                            <div class="emoj-group-list">
                              <ul>
                                ...
                                <li>
                                  <a href="javascript:void(0);"
                                    ><img src="@/assets/img/emojis/emoji-03.svg" alt="Icon"
                                  /></a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);"
                                    ><img src="@/assets/img/emojis/emoji-10.svg" alt="Icon"
                                  /></a>
                                </li>
                                <li>
                                  <a href="javascript:void(0);"
                                    ><img src="@/assets/img/emojis/emoji-09.svg" alt="Icon"
                                  /></a>
                                </li>
                                <li class="add-emoj">
                ...
                <div class="chat-content">
                  <div class="chat-info">
                    ...
                    <div class="chat-actions">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end p-1 list-unstyled">
                        <li>
                          <a class="dropdown-item" href="#"
                            ><i class="ti ti-heart me-2"></i>Reply</a
                          >
