  ...
  setup() {
    ...
    const saveDepartment = async () => {
      try {
        ...
        const payload = {
            ...
            is_active: departmentForm.value.is_active === true
        };
    ...
    const updateDepartment = async () => {
      try {
        ...
        const id = editDepartmentForm.value.id;
        const payload = {
            name: editDepartmentForm.value.name,
            description: editDepartmentForm.value.description,
            is_active: editDepartmentForm.value.is_active === true
        };

        await axiosInstance.patch(`/departments/${id}/`, payload)
