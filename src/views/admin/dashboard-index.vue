          ...
          <div class="position-relative border card rounded-2 shadow-sm">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                ></span>
                <div class="text-end">
                  <span class="badge px-2 py-1 fs-12 fw-medium d-inline-flex mb-1 bg-success"
                    >+95%</span
                  >
          ...
          <div class="position-relative border card rounded-2 shadow-sm">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-2 justify-content-between">
                ...
                ></span>
                <div class="text-end">
                  <span class="badge px-2 py-1 fs-12 fw-medium d-inline-flex mb-1 bg-danger"
                    >-15%</span
                  >
                  <p class="fs-13 mb-0">in last 7 Days</p>
                </div>
            ...
            <div class="card-body">
              ...
              >
                <div>
                  ...
                  <p class="mb-0 text-truncate">
                    <i class="ti ti-calendar-time me-1 text-dark"></i> Wed, 05 Apr 2025, 06:30 PM
                  </p>
                </div>
              ...
              >
                <div>
                  <h6 class="fs-14 fw-semibold mb-1">General Visit</h6>
                  <p class="mb-0 text-truncate">
                    <i class="ti ti-calendar-time me-1 text-dark"></i> Wed, 05 Apr 2025, 04:10 PM
                  </p>
                </div>
                <div class="avatar-list-stacked avatar-group-sm event flex-shrink-0">
                  <span class="avatar avatar-lg rounded-circle border-0"
              ...
              >
                <div>
                  <h6 class="fs-14 fw-semibold mb-1">General Visit</h6>
                  <p class="mb-0 text-truncate">
                    <i class="ti ti-calendar-time me-1 text-dark"></i> Wed, 05 Apr 2025, 10:00 AM
                  </p>
                </div>
                <div class="avatar-list-stacked avatar-group-sm event flex-shrink-0">
                  <span class="avatar avatar-lg rounded-circle border-0"
              ...
              <router-link to="/appointments/appointments-list" class="btn btn-light w-100"
        ...
        <div class="col-xl-4 col-lg-6 d-flex">
          <div class="card shadow-sm flex-fill w-100">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <router-link to="/doctors/doctor-schedule" class="btn fw-normal btn-outline-white"
                    ...
                    <div class="ms-2 flex-shrink-0">
                      <div>
                        <h6 class="fw-semibold fs-14 text-truncate mb-1">
                          <router-link to="/doctors/doctor-details">Dr. Sarah Johnson</router-link>
                        </h6>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <div class="d-flex align-items-center flex-shrink-0">
                    ...
                    <div class="ms-2 flex-shrink-0">
                      <div>
                        <h6 class="fw-semibold fs-14 text-truncate mb-1">
                          <router-link to="/doctors/doctor-details">Dr. Emily Carter</router-link>
                        </h6>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <div class="d-flex align-items-center flex-shrink-0">
                    ...
                    <div class="ms-2 flex-shrink-0">
                      <div>
                        <h6 class="fw-semibold fs-14 text-truncate mb-1">
                          <router-link to="/doctors/doctor-details">Dr. David Lee</router-link>
                        </h6>
                ...
                <div class="d-flex justify-content-between align-items-center mb-0">
                  <div class="d-flex align-items-center flex-shrink-0">
                    ...
                    <div class="ms-2 flex-shrink-0">
                      <div>
                        <h6 class="fw-semibold fs-14 text-truncate mb-1">
                          <router-link to="/doctors/doctor-details">Dr. Michael Smith</router-link>
                        </h6>
        ...
        <div class="col-xl-4 d-flex">
          <div class="card shadow-sm flex-fill w-100">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <router-link to="/patients/patients-list" class="btn fw-normal btn-outline-white"
                >View All</router-link
              >
            </div>
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center">
                  <router-link to="/patients/patient-details" class="avatar me-2 flex-shrink-0">
                    <img
                      src="@/assets/img/profiles/avatar-02.jpg"
                      alt="img"
                      class="rounded-circle"
                ...
                <span class="badge fw-medium badge-soft-primary border border-primary flex-shrink-0"
                  ...
                  <div class="ms-2">
                    <div>
                      <h6 class="fw-semibold text-truncate mb-1 fs-14">
                        <router-link to="/doctors/doctor-details">James Allaire</router-link>
                      </h6>
              ...
              <div class="d-flex justify-content-between mb-3">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    <div>
                      <h6 class="fw-semibold text-truncate mb-1 fs-14">
                        <router-link to="/doctors/doctor-details">Esther Schmidt</router-link>
                      </h6>
              ...
              <div class="d-flex justify-content-between mb-3">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    <div>
                      <h6 class="fw-semibold text-truncate mb-1 fs-14">
                        <router-link to="/doctors/doctor-details">Valerie Padgett</router-link>
                      </h6>
              ...
              <div class="d-flex justify-content-between mb-0">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    <div>
                      <h6 class="fw-semibold text-truncate mb-1 fs-14">
                        <router-link to="/doctors/doctor-details">Sally Cavazos</router-link>
                      </h6>
