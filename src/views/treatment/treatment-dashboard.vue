  ...
  <div class="page-wrapper">
    <div class="content pb-0">
      <div class="d-flex align-items-sm-center justify-content-between flex-wrap gap-2 mb-4">
        <div>
          <h4 class="fw-bold mb-0">Treatment Dashboard</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap gap-2">
          <router-link to="/appointments/new-appointment" class="btn btn-primary d-inline-flex align-items-center"><i class="ti ti-plus me-1"></i>New Treatment</router-link>
        </div>
      </div>
      <div class="row">
          ...
          <div class="position-relative border card rounded-2 shadow-sm">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-2 justify-content-between">
                <span class="avatar bg-primary rounded-circle"><i class="ti ti-heart fs-24"></i></span>
                <div class="text-end">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div>
                  ...
                  <h3 class="fw-bold mb-0">2,314</h3>
                </div>
                <div>
        ...
        <div class="col-xl-3 col-md-6">
          <div class="position-relative border card rounded-2 shadow-sm">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-2 justify-content-between">
                <span class="avatar bg-info rounded-circle"><i class="ti ti-activity fs-24"></i></span>
                <div class="text-end">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div>
                  ...
                  <h3 class="fw-bold mb-0">1,178</h3>
                </div>
                <div>
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between overflow-hidden">
                <div>
                  ...
                  <h3 class="fw-bold mb-0 text-truncate">$25,240</h3>
                </div>
                <div>
